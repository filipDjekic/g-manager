...
function renderPage() {
  ...
  return render(<QueryClientProvider client={client}><MemoryRouter><CustomersPage /></MemoryRouter></QueryClientProvider>)
}
...
describe('CustomersPage', () => {
  ...
  it('renders a customer with no history without invented data', async () => {
    server.use(http.get('/api/v1/customers', () => HttpResponse.json({ content: [{ id: 'customer-empty', name: 'Novi klijent', email: 'novi@example.test',
