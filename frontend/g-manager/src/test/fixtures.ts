...
const permissions: Record<Role, Permission[]> = {
  OWNER: ['PROFILE_READ', 'USER_LIST', 'CUSTOMER_READ', 'WORKING_HOURS_MANAGE', 'DASHBOARD_SUMMARY', 'AUDIT_READ'],
  ADMIN: ['PROFILE_READ', 'USER_LIST', 'CUSTOMER_READ', 'WORKING_HOURS_MANAGE', 'DASHBOARD_SUMMARY', 'AUDIT_READ'],
