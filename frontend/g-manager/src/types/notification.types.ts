import type { NavigationAction } from '../api/searchApi'
...
export interface AppNotification { id: string; type: NotificationType; priority: 'LOW' | 'NORMAL' | 'HIGH'; title: string; body: string; read: boolean; createdAt: string; action: NavigationAction | null }
