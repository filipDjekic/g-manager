    ...
    private final ApplicationContextRunner contextRunner =
            new ApplicationContextRunner()
                    ...
                    .withPropertyValues(
                            ...
                            "app.documents.max-file-bytes=5242880",
                            "app.documents.max-files-per-resource=20",
                            "app.documents.delete-retention-days=30",
                            "app.documents.backend=local",
                            "app.documents.s3-endpoint=",
                            "app.documents.s3-region=us-east-1",
                            "app.documents.s3-bucket=",
                            "app.documents.s3-access-key=",
                            "app.documents.s3-secret-key=",
