...
class OpenApiContractIntegrationTest {
    private static final Set<String> REQUIRED_PATHS = Set.of(
            ...
            "/api/v1/stations", "/api/v1/stations/{resourceId}/profile",
            "/api/v1/stations/applications", "/api/v1/stations/applications/{id}",
            ...
            "/api/v1/stations/{stationId}/machine-identity",
            "/api/v1/stations/{stationId}/machine-identity/enrollment-token",
            "/api/v1/stations/{stationId}/machine-identity/rotation-token",
            "/api/v1/stations/{stationId}/machine-identity/revoke",
            "/api/v1/machine/enroll", "/api/v1/machine/auth/challenge",
            "/api/v1/machine/auth/token", "/api/v1/machine/heartbeat",
            "/api/v1/machine/snapshot", "/api/v1/machine/commands",
            "/api/v1/machine/commands/{sequence}/ack",
