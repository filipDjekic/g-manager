...
env | grep -E '^(DEPLOY_ENV|APP_RELEASE|BACKEND_IMAGE|FRONTEND_IMAGE|CANONICAL_ORIGIN|APP_PORT|DOCUMENT_|AI_PROVIDER|AI_ENDPOINT|AI_MODEL|BACKUP_RETENTION_DAYS|STATION_POLICY_SIGNING_KEY_ID|GAMING_CLIENT_)=' > "$candidate"
